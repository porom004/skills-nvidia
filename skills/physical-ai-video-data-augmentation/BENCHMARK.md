...
- LOW SCHEMA/unexpected_file: Unexpected 'agents' in skill root (`skills/physical-ai-video-data-augmentation/agents`)
- LOW SCHEMA/author_format: Author must be of the form 'Name <email@host>' (`skills/physical-ai-video-data-augmentation/SKILL.md`)
